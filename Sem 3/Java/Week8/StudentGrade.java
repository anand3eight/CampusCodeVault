...
public class StudentGrade implements Attendance, Grade {
    ...
    public String name, dob, city, gender, grade;
    public int[] markarr = new int[5];

    public StudentGrade(String name, String dob, String city, String gender, int markarr[], int leaveDays,
            int sem) {
        this.name = name;
    ...
    public int agecal() {
        ...
        int birthYear = Integer.parseInt(datearr[2]);
